...
$lang = array(
	'label' => array(
		...
		'profile' => array(
			'age'            => 'Age',
			'ethnicity'      => 'Ethnicity',
			'female_mentors' => 'Number of female mentors on your team',
			'join_idea'      => 'Ideas you\'ve had to get girls involved in STEM',
			'new_girls'      => 'Number of girls new to the team this year',
		...
		'team' => array(
			'girls'     => 'Number of girls on your team (total)',
			'location'  => 'Location',
			'methods'   => 'How did you recruit members',
			'name'      => 'Team Name',
			'number'    => 'Team Number',
			'recruited' => 'Girls recruited this year',
			'size'      => 'Number of students on your team',
